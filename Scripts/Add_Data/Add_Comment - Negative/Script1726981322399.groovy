...
WebUI.setText(findTestObject('Object Repository/Add Data/Input_Token Data'), 'juan')

WebUI.sendKeys(findTestObject('Add Data/Input_Token Data'), Keys.chord(Keys.ENTER))
...
WebUI.click(findTestObject('Object Repository/Add Data/btn_PostComment'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Add Data/PopUp_RecordNotFound'))
