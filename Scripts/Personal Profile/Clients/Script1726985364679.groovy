...
WebUI.click(findTestObject('Object Repository/Personal Profile/div_NameClients'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Personal Profile/div_Profile'))
